...
private extension UINavigationBar {
    ...
    class func setDefaultAppearance() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.foregroundColor : UIColor.ttLightTextColor()]
    }
    ...
    class func setLightAppearance() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.foregroundColor : UIColor.ttAlternateTintColor()]
    }
}
